...
void OnStart()
  {
     ...
     double maxRealLoss =  pipvalue*lotSize*pips  ;
        ...
        ticket0=OrderSend(Symbol(),OP_SELLSTOP,lotSize,Price,slippage,Price+pips*Point*PipAdjust,Price-pips*Reward_Ratio1*Point*PipAdjust,"BUY STOP D1",0,expiration,Red);
        printError(ticket0);
        ticket1=OrderSend(Symbol(),OP_SELLSTOP,lotSize,Price,slippage,Price+pips*Point*PipAdjust,Price-pips*Reward_Ratio2*Point*PipAdjust,"BUY STOP D1",0,expiration,Red);
        printError(ticket1);
        ...
        if(Bid < Price)
        {
        ticket0=OrderSend(Symbol(),OP_BUYSTOP,lotSize,Price,slippage,Price-pips*Point*PipAdjust,Price+pips*Reward_Ratio1*Point*PipAdjust,"SELL STOP D1",0,expiration,Blue);
        printError(ticket0);
        ticket1=OrderSend(Symbol(),OP_BUYSTOP,lotSize,Price,slippage,Price-pips*Point*PipAdjust,Price+pips*Reward_Ratio2*Point*PipAdjust,"SELL STOP D1",0,expiration,Blue);
        printError(ticket1);
